...
<body>
  ...
  <div class="other">
    <c:if test="${about == null }">
	  <div class="other_tit">关于我们</div>
  	</c:if>
  	<c:if test="${about == 'jg'}">
	  <div class="other_tit">价格疑问</div>
  	</c:if>
  	<c:if test="${about == 'sx'}">
	  <div class="other_tit">商城详情</div>
  	</c:if>
      <div class="other_main">
        <c:if test="${about == null }">
	        <div style="text-align: center;" >web开发小组：曾昭赏 邓焯元 黄绍基</div>
	        <div style="text-align: center;" >有何疑问，请在工作时间拨打 132-4687-4458</div>
	  	</c:if>
	  	<c:if test="${about == 'jg'}">
	  		<div style="text-align: center;" >价格打折与上架天数的关系</div>
	  		<div style="text-align: center;" >上架1天：打9.5折</div>
	  		<div style="text-align: center;" >上架2天：打9折</div>
	  		<div style="text-align: center;" >上架3天：打8.5折</div>
	  		<div style="text-align: center;" >会员价：再打9折</div>
	  		<div style="text-align: center;" >（购买会员，请先注册普通会员）</div>
	  	</c:if>
	  	<c:if test="${about == 'sx' }">
	        <div style="text-indent:2em">五邑大学鲜果商城是邑大深受师生欢迎的水果购买平台，目前拥有近2万的注册用户数，每天有超过6百的固定访客，同时每天购买的水果已经超过了2百份。我们有最新鲜的水果最好吃的水果等您选购！</div>
	        <br/>
	        <div style="text-align: center;font:bold x-large 华文细黑">页面介绍</div>
	        <br/>
	        <div style="text-indent:20em">我们鲜果商城有多个水果分类：时令水果、硬皮水果、本周特惠和会员专区</div>
	        <div style="text-indent:20em">时令水果：当季热卖的水果</div>
	        <div style="text-indent:20em">硬皮水果：顾名思义，外皮比较厚，易于囤货吃</div>
	        <div style="text-indent:20em">本周特惠：价格相对其他水果便宜，或上架了2到3天</div>
	        <div style="text-indent:20em">会员专区：购买了会员的大福利哦，全页面都再打9折！</div>
	  	</c:if>
      </div>
    </div>
