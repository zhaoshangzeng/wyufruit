...
<body>
  ...
  <div class="other">
    <div class="other_tit">我的购物车</div>
      <div class="other_main"  style="background-image: url('${pageContext.request.contextPath }/img/gwcbj.jpg'); background-size: cover;">
      ...
      <table class="timetable_sub">
        ...
        <c:forEach var="one" items="${listcart }">
          <tr class="rem1">
            <td class="invert-closeb">
              <a href="${pageContext.request.contextPath }/DeleteListCart?delbuyid=${one.id}">
              <div class="rem">
            ...
            <td class="invert-image"><a href="${pageContext.request.contextPath }/Xq?id=${one.id}"><img src="${pageContext.request.contextPath }/img/${one.pictureUrlb}" alt=" " class="img-responsive" /></a></td>
            <td class="invert">${one.name }</td>
            <td class="invert">￥${one.price }元/${one.unit }</td>
            <td class="invert">
               <div class="quantity"> 
                <div class="quantity-select">                           
                  <!-- <div class="entry value-minus">&nbsp;</div> -->
                  <%-- <div class="entry value"><span>${one.amount }</span></div> --%>
                  <div class="entry"><span>${one.amount }</span></div>
                  <!-- <div class="entry value-plus active">&nbsp;</div> -->
                </div>
              </div>
            </td>
            <td class="invert">${one.totalPrice }元</td>
          </tr>
		    ...
		    <c:if test="${listcart != null && fn:length(listcart) == 0}">
		        <div style="text-align: center;" >
				 	您未购买任何商品！
		        </div>
			</c:if>
        <div class="checkout-right-basket animated wow slideInRight" data-wow-delay=".5s">
          <a href="${pageContext.request.contextPath }"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>继续 购买</a>
        </div>
        <div class="checkout-left-basket animated wow slideInRight" data-wow-delay=".5s">
          <a href="${pageContext.request.contextPath }/OrderDeal"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>生成 订单</a>
        </div>
      </div>
    </div>
