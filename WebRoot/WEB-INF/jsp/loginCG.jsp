  ...
  <form action="login_submit" method="get" accept-charset="utf-8">
    <div class="mauto">
      <div class="category_bar oh">
          <span class="fl">
              <a href="${pageContext.request.contextPath }">首页</a>&nbsp;&gt;&nbsp;登陆</span>
      </div>
      <div class="login_main"  style="background-image: url('${pageContext.request.contextPath }/img/dt.gif') ; background-size: cover; ">
			<br/><br/><br/> <center><h1 style="color:#fff;font-size: 27px;">欢迎您，${username }！</h1><center>
			<br/><center><h1 style="color:#fff;font-size: 17px;">5秒后回到首页</h1><center>
